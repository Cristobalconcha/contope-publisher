/**
 * ContOpe Canvas — compositor de video con transparencia real (luma matte).
 *
 ...
 *      escaneando `[data-cod-luma-matte="1"]`.
 *   2) Previsualización del editor: el core (`cod-editor-core.js`) lo invoca
...
(function (root, factory) {
    ...
    var ATTR = 'data-cod-luma-matte';
    var RUNTIME_ATTR = 'data-cod-luma-matte-runtime';
    var VIDEO_CLASS = 'cod-luma-matte__video';
    var CANVAS_CLASS = 'cod-luma-matte__canvas';
    var STYLE_ID = 'cod-luma-matte-video-styles';
    ...
    function installStyles(doc) {
        ...
        style.id = STYLE_ID;
        style.textContent = [
            '[data-cod-luma-matte="1"] { position:relative; display:block; line-height:0; }',
            '[data-cod-luma-matte="1"] .' + VIDEO_CLASS + ' { display:none !important; }',
            '[data-cod-luma-matte="1"] .' + CANVAS_CLASS + ' { display:block; width:100%; height:auto; }'
        ].join('');
        ...
        function renderFrame() {
            ...
            try {
                ...
                if (!state.primerCuadro) {
                    ...
                    wrapper.classList.add('cod-luma-matte--listo');
                    try {
                        wrapper.dispatchEvent(new CustomEvent('cod-luma-matte-listo', { bubbles: true }));
                    } catch (_error) {
        ...
        function playVideo() {
            ...
            if (playback && typeof playback.catch === 'function') {
                playback.catch(function () {
                    ...
                    // mismo patrón de `.cod-video-sound-toggle` del runtime
