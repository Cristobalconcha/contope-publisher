/*!
 * cod-interactions.js — interacciones tipo Webflow (MVP) para ContOpe Publisher.
 *
 ...
 *
 * Modelo de datos persistido como atributo declarativo `data-cod-interaction`
 ...
 * cod-behaviors.js): position, top, left, right, bottom, transform, opacity.
 ...
 * sitio publicado (cod-canvas-public.js) — un único archivo compartido, a
 * diferencia de la duplicación histórica de cod-behaviors/cod-canvas-public.
 *
 * Carga sin bundler (mismo patrón UMD que cod-behaviors.js):
 *   <script src="cod-interactions.js"></script> → window.OcdInteractions.
 */
(function (root, factory) {
  ...
  var PLUGIN_ID = 'cod-interactions';
  var ATTR = 'data-cod-interaction';
  ...
  /**
   * Parsea y normaliza el JSON de `data-cod-interaction`. Devuelve null ante
