...
(function () {
	...
	registerBlockType('ocd/heading', {
		title: __('Título OCD', 'contope-publisher'),
		description: __('Título con nivel h1-h6 como bloque Gutenberg nativo.', 'contope-publisher'),
		icon: 'heading',
		category: 'text',
			...
			return el(
				...
				el(
					...
					el(
						PanelBody,
						{
							title: __('Nivel del título', 'contope-publisher'),
							initialOpen: true
						},
						el(SelectControl, {
							label: __('Nivel', 'contope-publisher'),
				...
				el(RichText, Object.assign({}, blockProps, {
					...
					placeholder: __('Escribí el título…', 'contope-publisher'),
