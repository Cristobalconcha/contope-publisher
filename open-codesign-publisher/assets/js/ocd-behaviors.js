 ...
 *   valor de `data-ocd-behavior` se ignora. No hay superficie para ejecutar
 *   código arbitrario.
 *
...
(function (root, factory) {
  ...
  var ATTR_SCROLLED_CLASS = 'data-ocd-scrolled-class';
  ...
  var ATTR_TOGGLE_TARGET = 'data-ocd-toggle-target';
  var ATTR_TOGGLE_CLASS = 'data-ocd-toggle-class';
  var ATTR_TOGGLE_SELF_CLASS = 'data-ocd-toggle-self-class';
  var DEFAULT_TOGGLE_CLASS = 'is-menu-open';

  var ATTR_CAROUSEL_SLIDE_SELECTOR = 'data-ocd-carousel-slide-selector';
  var ATTR_CAROUSEL_ACTIVE_CLASS = 'data-ocd-carousel-active-class';
  var ATTR_CAROUSEL_START = 'data-ocd-carousel-start';
  var ATTR_CAROUSEL_NEXT = 'data-ocd-carousel-next';
  var ATTR_CAROUSEL_PREV = 'data-ocd-carousel-prev';
  var ATTR_CAROUSEL_DOTS = 'data-ocd-carousel-dots';
  var ATTR_CAROUSEL_DOT = 'data-ocd-carousel-dot';
  ...
  var ATTR_CAROUSEL_MODE = 'data-ocd-carousel-mode';
  var ATTR_CAROUSEL_TRACK_SELECTOR = 'data-ocd-carousel-track-selector';
  ...
  var DEFAULT_CAROUSEL_SLIDE_SELECTOR = '.ocd-carousel__slide';
  ...
  var ATTR_REVEAL_CLASS = 'data-ocd-reveal-class';
  ...
  var ATTR_LIGHTBOX_SOURCE = 'data-ocd-lightbox-source';
  var ATTR_LIGHTBOX_IMAGE_SELECTOR = 'data-ocd-lightbox-image-selector';
  var ATTR_LIGHTBOX_IMG = 'data-ocd-lightbox-img';
  var ATTR_LIGHTBOX_CLOSE = 'data-ocd-lightbox-close';
  var ATTR_LIGHTBOX_PREV = 'data-ocd-lightbox-prev';
  var ATTR_LIGHTBOX_NEXT = 'data-ocd-lightbox-next';
  var ATTR_LIGHTBOX_OPEN_CLASS = 'data-ocd-lightbox-open-class';
  ...
  // data-ocd-parcel-* (no JSON en el root); el panel y los colores se
  // referencian por selector en el root.
  var BEHAVIOR_PARCEL_MAP = 'parcel-map';
  var ATTR_PARCEL_ITEM_SELECTOR = 'data-ocd-parcel-item-selector';
  var ATTR_PARCEL_ID_ATTR = 'data-ocd-parcel-id-attr';
  var ATTR_PARCEL_SUPERFICIE = 'data-ocd-parcel-superficie';
  var ATTR_PARCEL_ACCENT_DISPONIBLE = 'data-ocd-parcel-accent-disponible';
  var ATTR_PARCEL_ACCENT_VENDIDO = 'data-ocd-parcel-accent-vendido';
  var ATTR_PARCEL_ACCENT_EMPTY = 'data-ocd-parcel-accent-empty';
  var ATTR_PARCEL_PANEL = 'data-ocd-parcel-panel';
  var ATTR_PARCEL_ACCENT = 'data-ocd-parcel-accent';
  var ATTR_PARCEL_FIELD_N = 'data-ocd-parcel-field-n';
  var ATTR_PARCEL_FIELD_ESTADO = 'data-ocd-parcel-field-estado';
  var ATTR_PARCEL_FIELD_SUP = 'data-ocd-parcel-field-sup';
  var ATTR_PARCEL_FIELD_VAL = 'data-ocd-parcel-field-val';
  var ATTR_PARCEL_COUNT = 'data-ocd-parcel-count';
  var ATTR_PARCEL_COUNT_SECONDARY = 'data-ocd-parcel-count-secondary';
  var ATTR_PARCEL_ESTADO = 'data-ocd-parcel-estado';
  var ATTR_PARCEL_VALOR = 'data-ocd-parcel-valor';
  ...
  var ATTR_GEO_PLACES = 'data-ocd-geo-places';
  var ATTR_GEO_CATEGORIES = 'data-ocd-geo-categories';
  var ATTR_GEO_DATA_BOUNDS = 'data-ocd-geo-data-bounds';
  var ATTR_GEO_INITIAL_CENTER = 'data-ocd-geo-initial-center';
  var ATTR_GEO_PROYECTO = 'data-ocd-geo-proyecto';
  var ATTR_GEO_MIN_ZOOM_RATIO = 'data-ocd-geo-min-zoom-ratio';
  var ATTR_GEO_SVG = 'data-ocd-geo-svg';
  var ATTR_GEO_SELECT_CATEGORIA = 'data-ocd-geo-select-categoria';
  var ATTR_GEO_SELECT_LUGAR = 'data-ocd-geo-select-lugar';
  var ATTR_GEO_MARKER = 'data-ocd-geo-marker';
  var ATTR_GEO_PANEL = 'data-ocd-geo-panel';
  var ATTR_GEO_ACCENT = 'data-ocd-geo-accent';
  ...
  var ATTR_HERO_PIN = 'data-ocd-hero-pin';
  var ATTR_HERO_NAV = 'data-ocd-hero-nav';
  var ATTR_HERO_REVEAL_TARGET = 'data-ocd-hero-reveal-target';
  var ATTR_HERO_COLLAPSE_ON = 'data-ocd-hero-collapse-on';
  var ATTR_HERO_COLLAPSE_OFF = 'data-ocd-hero-collapse-off';
  var ATTR_HERO_DWELL = 'data-ocd-hero-dwell';
  var ATTR_HERO_COLLAPSED_HEIGHT = 'data-ocd-hero-collapsed-height';
  var ATTR_HERO_REVEAL_DELAY = 'data-ocd-hero-reveal-delay';
  var ATTR_HERO_CRYSTALLIZE_OFFSET = 'data-ocd-hero-crystallize-offset';
  var ATTR_HERO_COLLAPSED_CLASS = 'data-ocd-hero-collapsed-class';
  var ATTR_HERO_BODY_CLASS = 'data-ocd-hero-body-class';
  var ATTR_HERO_CRYSTALLIZED_CLASS = 'data-ocd-hero-crystallized-class';
  var ATTR_HERO_HANDOFF_CLASS = 'data-ocd-hero-handoff-class';
  var ATTR_HERO_REVEALED_CLASS = 'data-ocd-hero-revealed-class';
  ...
  // en data-ocd-chart-data y el SVG se genera en runtime con createElementNS,
  // sin librerías externas y sin interpretar el JSON como código.
  var BEHAVIOR_CHART = 'chart';
  var ATTR_CHART_TYPE = 'data-ocd-chart-type';
  var ATTR_CHART_DATA = 'data-ocd-chart-data';
  var ATTR_CHART_COLOR = 'data-ocd-chart-color';
  var ATTR_CHART_AXIS_COLOR = 'data-ocd-chart-axis-color';
  var ATTR_CHART_GRID_COLOR = 'data-ocd-chart-grid-color';
  var ATTR_CHART_LABEL_COLOR = 'data-ocd-chart-label-color';
  var ATTR_CHART_WIDTH = 'data-ocd-chart-width';
  var ATTR_CHART_HEIGHT = 'data-ocd-chart-height';
  ...
  BEHAVIORS[BEHAVIOR_CAROUSEL_BASIC] = {
    ...
    description: 'Muestra un slide a la vez con navegación next/prev y dots opcionales (modo "single", default), o desliza una tira con varias fotos visibles (modo "track", data-ocd-carousel-mode="track").',
  };
  ...
  function installNavToggleRuntime(win, doc, opts, cleanups) {
    var nodes = doc.querySelectorAll('[data-ocd-behavior="nav-toggle"]');
    for (var i = 0; i < nodes.length; i++) {
      (function (button) {
  ...
  function installCarouselRuntime(win, doc, opts, cleanups) {
    var roots = doc.querySelectorAll('[data-ocd-behavior="carousel-basic"]');
  ...
  function installRevealRuntime(win, doc, opts, cleanups) {
    var nodes = doc.querySelectorAll('[data-ocd-behavior="reveal-on-scroll"]');
  ...
  function installLightboxRuntime(win, doc, opts, cleanups) {
    var roots = doc.querySelectorAll('[data-ocd-behavior="lightbox"]');
    for (var i = 0; i < roots.length; i++) {
      (function (root) {
        var declared = root.getAttribute(ATTR_BEHAVIOR);
  ...
  // (data-ocd-parcel-estado / data-ocd-parcel-valor), no JSON en el root.
  function installParcelMapRuntime(win, doc, opts, cleanups) {
    var roots = doc.querySelectorAll('[data-ocd-behavior="parcel-map"]');
    for (var i = 0; i < roots.length; i++) {
      (function (root) {
        var declared = root.getAttribute(ATTR_BEHAVIOR);
  ...
  function installGeoMapRuntime(win, doc, opts, cleanups) {
    var roots = doc.querySelectorAll('[data-ocd-behavior="geo-map"]');
    for (var i = 0; i < roots.length; i++) {
      (function (root) {
        var declared = root.getAttribute(ATTR_BEHAVIOR);
  ...
  function installHeroCollapseRuntime(win, doc, opts, cleanups) {
    ...
    var roots = doc.querySelectorAll('[data-ocd-behavior="hero-collapse"]');
    for (var i = 0; i < roots.length; i++) {
      (function (root) {
        var declared = root.getAttribute(ATTR_BEHAVIOR);
  ...
  // data-ocd-chart-data. El JSON se parsea con JSON.parse y cada valor se
  ...
  function installChartRuntime(win, doc, opts, cleanups) {
    var roots = doc.querySelectorAll('[data-ocd-behavior="chart"]');
  ...
  function runtimeScript(options) {
    ...
    return [
      '/* ocd-behaviors runtime: scroll-threshold, nav-toggle, carousel-basic, reveal-on-scroll, lightbox, parcel-map, geo-map, hero-collapse, chart (allowlisted). Sin eval/Function. */',
      '(function () {',
      '  "use strict";',
      '  var ATTR_BEHAVIOR = "data-ocd-behavior";',
      '  var ATTR_THRESHOLD = "data-ocd-scroll-threshold";',
      ...
      '    var nodes = d.querySelectorAll(\'[data-ocd-behavior="nav-toggle"]\');',
      '    for (var i = 0; i < nodes.length; i++) {',
      '      (function (button) {',
      ...
      '    var roots = d.querySelectorAll(\'[data-ocd-behavior="carousel-basic"]\');',
      '    for (var i = 0; i < roots.length; i++) {',
      '      (function (root) {',
      ...
      '    var nodes = d.querySelectorAll(\'[data-ocd-behavior="reveal-on-scroll"]\');',
      ...
      '    var roots = d.querySelectorAll(\'[data-ocd-behavior="parcel-map"]\');',
      '    for (var i = 0; i < roots.length; i++) {',
      '      (function (root) {',
      ...
      '    var roots = d.querySelectorAll(\'[data-ocd-behavior="geo-map"]\');',
      '    for (var i = 0; i < roots.length; i++) {',
      '      (function (root) {',
      ...
      '    var roots = d.querySelectorAll(\'[data-ocd-behavior="hero-collapse"]\');',
      '    for (var i = 0; i < roots.length; i++) {',
      '      (function (root) {',
      ...
      '    var roots = d.querySelectorAll("[data-ocd-behavior=chart]");',
      '    var SVG_NS = "http://www.w3.org/2000/svg";',
      '    for (var i = 0; i < roots.length; i++) {',
      '      (function (root) {',
  ...
  function runtimeCss(options) {
    ...
    return [
      '/* ocd-behaviors: hooks declarativos. La animación real la define el',
      ...
      '[data-ocd-behavior="nav-toggle"] { cursor: pointer; }',
      ...
      '[data-ocd-behavior="carousel-basic"] .ocd-carousel__slide { display: none; }',
      '[data-ocd-behavior="carousel-basic"] .ocd-carousel__slide.is-active { display: block; }',
      ...
      '[data-ocd-behavior="reveal-on-scroll"] { opacity: 0; }',
      '[data-ocd-behavior="reveal-on-scroll"].is-revealed { opacity: 1; transition: opacity .4s ease; }',
      '[data-ocd-behavior="chart"] { container-type: inline-size; }',
      '[data-ocd-behavior="chart"] svg { display: block; width: 100%; height: auto; overflow: visible; }',
    ].join('\n');
  }
