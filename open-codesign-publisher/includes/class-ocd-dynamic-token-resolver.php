 ...
 * `data-ocd-dynamic="acf_image:CAMPO"` sobre etiquetas `<img>`. Todas las
...
final class OCD_Dynamic_Token_Resolver
{
    ...
    /**
     * Reemplaza `<img data-ocd-dynamic="acf_image:CAMPO">` por la URL de la
    ...
    {
        return preg_replace_callback(
            '/<img\b[^>]*\bdata-ocd-dynamic\s*=\s*(["\'])acf_image:([a-zA-Z0-9_\-]+)\1[^>]*>/i',
