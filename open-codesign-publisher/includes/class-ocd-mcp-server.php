 ...
 */
final class OCD_MCP_Server
{
    public const REST_NAMESPACE = 'open-codesign/v1';
    ...
    public function __construct(private OCD_Canvas_MCP_Service $service)
    {
    }
    ...
    private function handle_tool_call($id, array $params, bool $is_modern): WP_REST_Response
    {
        ...
        if (!is_array($arguments)) {
            return $this->tool_error($id, 'ocd_mcp_invalid_arguments', 'arguments debe ser un objeto JSON.', $is_modern);
        }
    ...
    {
        return [
            'name' => 'open-codesign-wordpress',
            'version' => OCD_PUBLISHER_VERSION,
        ];
    }
