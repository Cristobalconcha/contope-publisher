...
final class OCD_Canvas_Asset_Resolver
{
    ...
    public function resolve(array $references): array
    {
        ...
        $managed_root = trailingslashit((string) $uploads['basedir']) . 'open-codesign';
        $managed_url = trailingslashit((string) $uploads['baseurl']) . 'open-codesign';
