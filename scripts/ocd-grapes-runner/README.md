...
1. Le pide el documento real al sitio (`ocd_read_canvas_document`)
...
3. Guarda de vuelta el HTML/CSS/árbol que **Grapes mismo** generó (`ocd_write_canvas_document`)
...
- El plugin Open CoDesign Publisher 0.2.77 o superior en el sitio

## Configuración (una sola vez)

1. Copiá `ocd-grapes-runner.config.example.json` como `ocd-grapes-runner.config.json`
...
El motor de construcción (`open-codesign-publisher/tools/ocd-headless-build.mjs`) corre
